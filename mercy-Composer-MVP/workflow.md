...
本文档详细描述了慈善捐赠系统 MVP 版本的完整工作流程，包括系统架构、初始化、参与者交互、操作顺序和关键功能。
...
# 安装业务网络
composer network install --card PeerAdmin@hlfv1 --archiveFile mercy-charity-mvp@0.0.1.bna

# 启动业务网络
composer network start --networkName mercy-charity-mvp --networkVersion 0.0.1 --networkAdmin admin --networkAdminEnrollSecret adminpw --card PeerAdmin@hlfv1

# 导入管理员卡片
composer card import --file admin@mercy-charity-mvp.card
```
